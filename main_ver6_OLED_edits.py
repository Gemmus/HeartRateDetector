...
def welcome_text():
    ...
    for i in range(6):
        ...
        oled.line(3+h, 4, 5+h, 4, 0)
        oled.line(3+h, 55, 5+h, 55, 0)

        oled.line(7+h, 4, 9+h, 4, 0)
        oled.line(7+h, 55, 9+h, 55, 0)

        oled.line(2+h, 5, 10+h, 5, 0)
        oled.line(2+h, 56, 10+h, 56, 0)

        oled.line(3+h, 6, 9+h, 6, 0)
        oled.line(3+h, 57, 9+h, 57, 0)

        oled.line(4+h, 7, 8+h, 7, 0)
        oled.line(4+h, 58, 8+h, 58, 0)

        oled.line(5+h, 8, 7+h, 8, 0)
        oled.line(5+h, 59, 7+h, 59, 0)
    ...
    for i in range(2):
        ...
        oled.line(3+v, 20, 5+v, 20, 0)
        oled.line(3+v, 38, 5+v, 38, 0)

        oled.line(7+v, 20, 9+v, 20, 0)
        oled.line(7+v, 38, 9+v, 38, 0)

        oled.line(2+v, 21, 10+v, 21, 0)
        oled.line(2+v, 39, 10+v, 39, 0)

        oled.line(3+v, 22, 9+v, 22, 0)
        oled.line(3+v, 40, 9+v, 40, 0)

        oled.line(4+v, 23, 8+v, 23, 0)
        oled.line(4+v, 41, 8+v, 41, 0)

        oled.line(5+v, 24, 7+v, 24, 0)
        oled.line(5+v, 42, 7+v, 42, 0)
...
welcome_text()
avg_size = 128 #int(samplerate * 0.5)
        ...
        while capture_count < capture_length:
            if not samples.empty():
                ...
                if disp_count >= disp_div:
                    ...
                    oled.text(f'Timer:  {int(capture_count/samplerate)}s', 19, 56, 0)
